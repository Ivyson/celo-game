const level1Questions = [
  ...
  },
  {
    ...
    question: "$$f(x) = 2x^2 - 3x + 1, \\quad f(2) = ?$$",
    answers: [
      "$$3$$", 
      "$$7$$", 
      "$$5$$", 
    ...
    solution: [
      ...
      "Step 2: $$f(2) = 2(2)^2 - 3(2) + 1$$",
      "Step 3: $$f(2) = 2(4) - 6 + 1 = 8 - 6 + 1 = 3$$"
    ],
...
const level2Questions = [
  {
    ...
    solution: [
      ...
      "Step 2: $$\\frac{d}{dx}(3x^3) = 9x^2, \\quad \\frac{d}{dx}(-5x^2) = -10x$$",
  ...
  },
  {
    ...
    difficulty: "intermediate",
    category: "calculus",
    background: "Find the derivative of the function, if it's defined as:",
...
const level3Questions = [
  ...
  },
  {
    ...
    reward: 20,
    solution: [
      "Step 1: Treat \\(y\\) as a constant number.",
    ...
    hint: "Ignore all y terms that don't contain x, or treat them like coefficients."
  },
  {
    id: "l3-q3",
    level: 3,
...
const level4Questions = [
  {
    ...
    background: " ",
    question: "If $(X \\sim N(100, 15^2)$, what is \\(P(X > 115)\\) approximately? (Use empirical rule)",
    answers: ["$$0.16$$", "$$0.32$$", "$$0.025$$", "$$0.05$$"],
    correctAnswer: "$$0.16$$",
    reward: 25,
    solution: [
      "Step 1: X follows Normal distribution with \\(\\mu = 100\\), \\(\\sigma = 15\\)",
      "Step 2: $$115 = \\mu + \\sigma = 100 + 15$$ (one standard deviation above mean)",
      "Step 3: By empirical rule, 68% of data is within \\(1\\sigma\\) of mean",
      "Step 4: So 32% is outside, split equally: 16% above, 16% below",
      "Step 5: $$P(X > 115) \\approx 0.16$$"
    ],
  ...
  },
  {
    ...
    category: "linear_algebra",
    background: " ",
    question: "What are the eigenvalues of matrix $\\begin{bmatrix} 4 & 1 \\\\ 2 & 3 \\end{bmatrix}$?",
    answers: ["$$\\lambda = 5, 2$$", "$$\\lambda = 4, 3$$", "$$\\lambda = 6, 1$$", "$$\\lambda = 3, 2$$"],
    correctAnswer: "$$\\lambda = 5, 2$$",
    reward: 25,
    solution: [
      "Step 1: Find \\(\\det(A - \\lambda I) = 0\\)",
      "Step 2: $$\\det\\begin{bmatrix} 4-\\lambda & 1 \\\\ 2 & 3-\\lambda \\end{bmatrix} = 0$$",
      "Step 3: $$(4-\\lambda)(3-\\lambda) - (1)(2) = 0$$",
      "Step 4: $$12 - 7\\lambda + \\lambda^2 - 2 = 0$$",
      "Step 5: $$\\lambda^2 - 7\\lambda + 10 = 0$$",
      "Step 6: $$(\\lambda - 5)(\\lambda - 2) = 0$$",
      "Step 7: $$\\lambda = 5$$ or $$\\lambda = 2$$"
    ],
  ...
  },
  {
    ...
    background: " ",
    question: "What is $|e^{i\\pi} + 1|$?",
    answers: ["$$0$$", "$$1$$", "$$2$$", "$$e$$"],
    correctAnswer: "$$0$$",
    reward: 25,
    solution: [
      "Step 1: Apply Euler's formula: $$e^{i\\theta} = \\cos(\\theta) + i\\sin(\\theta)$$",
      "Step 2: $$e^{i\\pi} = \\cos(\\pi) + i\\sin(\\pi)$$",
      "Step 3: $$e^{i\\pi} = -1 + 0i = -1$$",
      "Step 4: $$e^{i\\pi} + 1 = -1 + 1 = 0$$",
  ...
  },
  {
    ...
    background: "Is the function differentiable at the given point?",
    question: " $f(x) = \\lvert x \\rvert$ \; $x = 0$",
    answers: ["No", "Yes", "Only from the right", "Only from the left"],
    correctAnswer: "No",
    reward: 25,
    solution: [
      "Step 1: Check left-hand derivative: $$\\lim_{h\\to 0^-} \\frac{|0+h| - |0|}{h} = \\lim_{h\\to 0^-} \\frac{|h|}{h} = -1$$",
      "Step 2: Check right-hand derivative: $$\\lim_{h\\to 0^+} \\frac{|0+h| - |0|}{h} = \\lim_{h\\to 0^+} \\frac{|h|}{h} = 1$$",
      "Step 3: Since left and right derivatives differ \\((-1 \\neq 1)\\)",
  ...
  },
  {
    ...
    background: "Find critical points of:",
    question: " $$f(x,y) = x^2 + y^2 - 4x + 6y + 5$$",
    answers: ["$$(2, -3)$$", "$$(-2, 3)$$", "$$(2, 3)$$", "$$(-2, -3)$$"],
    correctAnswer: "$$(2, -3)$$",
    reward: 25,
    solution: [
      "Step 1: Find partial derivatives: $$\\frac{\\partial f}{\\partial x} = 2x - 4, \\quad \\frac{\\partial f}{\\partial y} = 2y + 6$$",
      "Step 2: Set $$\\frac{\\partial f}{\\partial x} = 0$$: $$2x - 4 = 0 \\implies x = 2$$",
      "Step 3: Set $$\\frac{\\partial f}{\\partial y} = 0$$: $$2y + 6 = 0 \\implies y = -3$$",
